...
export async function NavbarMobile() {
  ...
  return (
    <>
      <div className="fixed inset-x-0 bottom-0 z-40 h-20 w-full bg-popover to-transparent backdrop-blur-lg [-webkit-mask-image:linear-gradient(to_top,black,transparent)] lg:hidden"></div>
