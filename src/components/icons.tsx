...
export const Icons = {
  checkCircle: ({ className, ...props }: IconProps) => (
    <svg
      className={cn('size-5 text-green-800', className)}
  ...
  shoppingCart: ({ className, ...props }: IconProps) => (
    <svg
  ...
  shoppingCartPlus: ({ className, ...props }: IconProps) => (
    <svg
      className={cn('h-5 w-5', className)}
      xmlns="http://www.w3.org/2000/svg"
      width="24"
  ...
  loadingDots: ({ className, ...props }: IconProps) => (
    <svg
      className={`size-5 text-muted-foreground ${className}`}
      {...props}
      fill="currentColor"
      viewBox="0 0 24 24"
      xmlns="http://www.w3.org/2000/svg"
